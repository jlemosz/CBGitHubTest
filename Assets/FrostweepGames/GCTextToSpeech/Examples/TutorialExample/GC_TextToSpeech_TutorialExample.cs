...
using static FrostweepGames.Plugins.GoogleCloud.TextToSpeech.Enumerators;
...
namespace FrostweepGames.Plugins.GoogleCloud.TextToSpeech.Example
{
    public class GC_TextToSpeech_TutorialExample : MonoBehaviour
    {
        ...
        public Dropdown voiceGenderDropdown;
        ...
        private void SynthesizeButtonOnClickHandler()
        {
            ...
            if (GeneralConfig.Config.betaAPI)
            {
                ...
                _currentVoice.naturalSampleRateHertz, new Enumerators.EffectsProfileId[] { },
        ...
        private void VoiceSelectedDropdownOnChangedHandler(int index)
        {
            ...
            voiceGenderDropdown.ClearOptions();
            voiceGenderDropdown.AddOptions(new List<string>() { _currentVoice.ssmlGender.ToString() });
        }
